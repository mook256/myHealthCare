...
import { last, filter as rxjsFilter } from 'rxjs/operators';

import { readDateTime } from '../bufferUtils';
import { BLOOD_PRESSURE } from '../types';

const NAME = 'BM57'; // beurer medical BM57 Sphygmomanometer
const DEVICE_NAME = 'Beurer medical BM57 Sphygmomanometer';
const KEY = 'beurer_bm57_bp';
