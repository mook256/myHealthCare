...
const NAME = 'HEM-7361T'; // beurer medical BM77 Sphygmomanometer
const DEVICE_NAME = 'OMRON HEM-7361T Blood Pressure monitor';
const KEY = 'omron_hem7361t_bp';
...
function monitor(device: Device) {
  ...
  return subject.pipe(
    rxjsFilter((data) => data?.payload?.userId === 1),
    take(1),
  );
}
